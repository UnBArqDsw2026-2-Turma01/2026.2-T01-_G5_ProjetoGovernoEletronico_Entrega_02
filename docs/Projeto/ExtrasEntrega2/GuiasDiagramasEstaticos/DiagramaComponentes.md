### Diagramas Estáticos 
# Guia do Diagrama de Componentes 

Este documento apresenta uma introdução ao **[Nome do Diagrama]** e orientações sobre a escolha e utilização de ferramentas de modelagem para o projeto.
