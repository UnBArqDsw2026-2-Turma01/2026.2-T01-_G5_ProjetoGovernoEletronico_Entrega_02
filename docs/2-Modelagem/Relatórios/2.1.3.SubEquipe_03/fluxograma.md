...
![Tela de autenticação via gov.br](../assets/subequipe03-modelagem/fluxogramas/pagina-gov.png)

<center><strong>Legenda:</strong> Figura 1 - Tela de autenticação do cidadão via gov.br</center>

![Tela inicial do Meu SUS Digital](../assets/subequipe03-modelagem/fluxogramas/pagina-inicial.png)

<center><strong>Legenda:</strong> Figura 2 - Tela inicial (Dashboard) do Meu SUS Digital após a autenticação, com as seções "Minha Saúde" e "Mini apps"</center>

![Tela Rede de Saúde](../assets/subequipe03-modelagem/fluxogramas/pagina-redes-saude.png)

<center><strong>Legenda:</strong> Figura 3 - Categorias de estabelecimentos disponíveis na Rede de Saúde</center>

![Lista e mapa de estabelecimentos próximos](../assets/subequipe03-modelagem/fluxogramas/pagina-redes-proximas.png)

<center><strong>Legenda:</strong> Figura 4 - Mapa e listagem de estabelecimentos próximos ao selecionar a categoria "Hospital"</center>

![Tela de detalhes do estabelecimento](../assets/subequipe03-modelagem/fluxogramas/pagina-detalhes-local.png)

<center><strong>Legenda:</strong> Figura 5 - Detalhes do estabelecimento de saúde selecionado</center>

![Tela de Conteúdo](../assets/subequipe03-modelagem/fluxogramas/pagina-conteudo.png)

<center><strong>Legenda:</strong> Figura 6 - Tela "Conteúdo", com categorias de filtro e listagem de artigos</center>

![Tela de conteúdo específico](../assets/subequipe03-modelagem/fluxogramas/pagina-conteudo-especifico.png)

<center><strong>Legenda:</strong> Figura 7 - Tela de leitura de um conteúdo específico selecionado</center>
